...
## SASS
Using the SASS from the Poole project I was able to move hyde from CSS to SASS. While I'm not taking advantage of everything SASS has to offer it is nice to have variables and partials.
